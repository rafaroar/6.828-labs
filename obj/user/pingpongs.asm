...
sys_env_destroy(envid_t envid)
{
  ...
  800c20:	00 
  800c21:	c7 44 24 08 e8 14 80 	movl   $0x8014e8,0x8(%esp)
  800c28:	00 
  800c29:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c30:	00 
  800c31:	c7 04 24 05 15 80 00 	movl   $0x801505,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800cb2:	00 
  800cb3:	c7 44 24 08 e8 14 80 	movl   $0x8014e8,0x8(%esp)
  800cba:	00 
  800cbb:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cc2:	00 
  800cc3:	c7 04 24 05 15 80 00 	movl   $0x801505,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800d05:	00 
  800d06:	c7 44 24 08 e8 14 80 	movl   $0x8014e8,0x8(%esp)
  800d0d:	00 
  800d0e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d15:	00 
  800d16:	c7 04 24 05 15 80 00 	movl   $0x801505,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d58:	00 
  800d59:	c7 44 24 08 e8 14 80 	movl   $0x8014e8,0x8(%esp)
  800d60:	00 
  800d61:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d68:	00 
  800d69:	c7 04 24 05 15 80 00 	movl   $0x801505,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800dab:	00 
  800dac:	c7 44 24 08 e8 14 80 	movl   $0x8014e8,0x8(%esp)
  800db3:	00 
  800db4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dbb:	00 
  800dbc:	c7 04 24 05 15 80 00 	movl   $0x801505,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800dfe:	00 
  800dff:	c7 44 24 08 e8 14 80 	movl   $0x8014e8,0x8(%esp)
  800e06:	00 
  800e07:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e0e:	00 
  800e0f:	c7 04 24 05 15 80 00 	movl   $0x801505,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800e73:	00 
  800e74:	c7 44 24 08 e8 14 80 	movl   $0x8014e8,0x8(%esp)
  800e7b:	00 
  800e7c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e83:	00 
  800e84:	c7 04 24 05 15 80 00 	movl   $0x801505,(%esp)
...
fork(void)
{
  ...
  800e9e:	c7 44 24 08 1f 15 80 	movl   $0x80151f,0x8(%esp)
  800ea5:	00 
  800ea6:	c7 44 24 04 51 00 00 	movl   $0x51,0x4(%esp)
  800ead:	00 
  800eae:	c7 04 24 13 15 80 00 	movl   $0x801513,(%esp)
...
sfork(void)
{
  ...
  800ec0:	c7 44 24 08 1e 15 80 	movl   $0x80151e,0x8(%esp)
  800ec7:	00 
  800ec8:	c7 44 24 04 58 00 00 	movl   $0x58,0x4(%esp)
  800ecf:	00 
  800ed0:	c7 04 24 13 15 80 00 	movl   $0x801513,(%esp)
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  800ee2:	c7 44 24 08 34 15 80 	movl   $0x801534,0x8(%esp)
  800ee9:	00 
  800eea:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800ef1:	00 
  800ef2:	c7 04 24 4d 15 80 00 	movl   $0x80154d,(%esp)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  800f04:	c7 44 24 08 57 15 80 	movl   $0x801557,0x8(%esp)
  800f0b:	00 
  800f0c:	c7 44 24 04 2a 00 00 	movl   $0x2a,0x4(%esp)
  800f13:	00 
  800f14:	c7 04 24 4d 15 80 00 	movl   $0x80154d,(%esp)
