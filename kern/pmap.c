...
{
	//cprintf("DEBUG boot_alloc has been called!\n");
...
mem_init(void)
{
	//cprintf("DEBUG mem_init has been called!\n");
...
page_init(void)
{
	...
	// as in use
	//cprintf("DEBUG page_init has been called!\n");
...
{
	/*/take the first 10 bits -> page directory index
	uint32_t pdx = PDX(va);

	//take the next 10 bits -> page table index
	uint32_t ptx = PTX(va);*/
