...
trap_init(void)
{
	...
	SETGATE(idt[20], 0, GD_KT, handler20, 0);
	SETGATE(idt[21], 0, GD_KT, handler21, 0);
	SETGATE(idt[22], 0, GD_KT, handler22, 0);
	SETGATE(idt[23], 0, GD_KT, handler23, 0);
	SETGATE(idt[24], 0, GD_KT, handler24, 0);
	SETGATE(idt[25], 0, GD_KT, handler25, 0);
	SETGATE(idt[26], 0, GD_KT, handler26, 0);
	SETGATE(idt[27], 0, GD_KT, handler27, 0);
	SETGATE(idt[28], 0, GD_KT, handler28, 0);
	SETGATE(idt[29], 0, GD_KT, handler29, 0);
...
{
	//cprintf("DEBUG trap_dispatch() was called");
